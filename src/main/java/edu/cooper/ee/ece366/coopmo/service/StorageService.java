...
import edu.cooper.ee.ece366.coopmo.error.StorageException;
import edu.cooper.ee.ece366.coopmo.error.StorageFileNotFoundException;
...
public class StorageService {
    ...
    public void store(MultipartFile file, String fn) {
        String filename = StringUtils.cleanPath(fn);
        try {
            if (file.isEmpty()) {
