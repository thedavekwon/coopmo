    ...
    return (
      <div>
        ...
        >
          <div
            id="I38:417;38:411"
            style={{ width: 16, marginLeft: "70%", height: 16, marginTop: -46 }}
            className="innerDiv"
          >
            <div
              className="vector"
        ...
        <div
          style={{ zIndex: 5, alignItems: "center" }}
          className="outerDiv centerer"
        >
          <div
            id="I38:417;35:534"
        ...
        <div
          style={{ zIndex: 6, alignItems: "center" }}
          className="outerDiv centerer"
        >
          <div
            id="I38:417;35:535"
            style={{ width: 16, marginLeft: "70%", height: 16, marginTop: 52 }}
            className="innerDiv"
          >
            <div
              className="vector"
